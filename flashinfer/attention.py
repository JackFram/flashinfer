...
def get_pipe_attention_module():
    return load_cuda_ops(
        "piped_persistent_attention",
        [
            FLASHINFER_CSRC_DIR / "batch_persistent.cu",
            FLASHINFER_CSRC_DIR / "batch_persistent_pipe_pybind.cu",
        ],
    )
...
class PipeBatchAttention:
    def __init__(
        ...
        self.module = get_pipe_attention_module()
