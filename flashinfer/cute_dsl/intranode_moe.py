...
def test_loop(dist_param: ProcessGroupInfo):
    ...
    num_tokens_per_rank, hidden_dim, num_topk, num_experts = 64, 7168, 8, (32 // num_ranks) * num_ranks
    ...
    src_route = torch.zeros((max_token_per_rank), dtype=torch.int32, device='cuda')
    ...
    src_route_cute = from_dlpack(src_route, assumed_align=16)
    ...
    # print(recv_token_tensor[:, :, 0, 0, 0].cpu())
